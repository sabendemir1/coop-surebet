...
interface MoneyProviderDialogProps {
  isOpen: boolean;
  onClose: () => void;
  opportunity: {
    teamA: string;
...
const MoneyProviderDialog = ({ isOpen, onClose, opportunity }: MoneyProviderDialogProps) => {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-bold">${opportunity.depositAmount.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between border-t pt-2">
                ...
                <span className="font-bold text-green-400">${opportunity.sellValue.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-muted-foreground">Edge Profit (1/3):</span>
                <span className="font-bold text-green-400">+${opportunity.edgeProfit.toFixed(2)}</span>
              </div>
            </div>
            ...
            <div className="bg-blue-500/10 p-3 rounded-lg border border-blue-500/20">
              ...
              <ol className="text-xs text-muted-foreground mt-1 space-y-1">
                <li>1. You deposit ${opportunity.depositAmount.toLocaleString()}</li>
                <li>2. Other user buys {opportunity.cryptoType} and sends to platform</li>
                <li>3. You receive {opportunity.amount.toFixed(2)} {opportunity.cryptoType}</li>
                <li>4. You can sell it for ${opportunity.sellValue.toLocaleString()}</li>
              </ol>
            </div>
          ...
          <div className="space-y-4">
            <div className="text-center p-4 bg-yellow-500/10 rounded-lg border border-yellow-500/20">
              ...
              <p className="text-sm text-muted-foreground">
                Waiting for the other user to buy and send {opportunity.cryptoType} to platform...
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span>${opportunity.depositAmount.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">You Received:</span>
                  <span className="text-green-400">{opportunity.amount.toFixed(2)} {opportunity.cryptoType}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Current Sell Value:</span>
                  <span className="text-green-400">${opportunity.sellValue.toLocaleString()}</span>
                </div>
                <div className="flex justify-between border-t pt-2">
            ...
            <div className="bg-green-500/10 p-3 rounded-lg border border-green-500/20">
              ...
              <p className="text-xs text-muted-foreground">
                You can now sell your {opportunity.amount.toFixed(2)} {opportunity.cryptoType} for ${opportunity.sellValue.toLocaleString()} and keep the profit!
              </p>
            </div>
...
export default MoneyProviderDialog;